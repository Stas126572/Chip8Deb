...
**Возможности:**
* Три режима:_version2_Simple/Disasm>ls
LICENSE  Makefile  README.md  disasmTableGenerator.c  main.c
...
U / R: Undo / Redo support.
 выполнение (running), пошаговый (step-by-step) и редактирование.
* Три окна: листинг программы, значения регистров и экран самой VM.
* Система уровней точек останова (Breakpoints).
...
Q: Quit.
Build:
Requires ncurses. Run make chip8_emu.
Usage: ./chip8_emu <path_to_rom>
